		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comdemofirstapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemofirstapp-display": {
								"semanticObject": "comdemofirstapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.firstapp",
									"url": sap.ui.require.toUrl("com/demo/firstapp")
								}
							}
						}
					}
